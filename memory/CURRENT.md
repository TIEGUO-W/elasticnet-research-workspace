...
> 最后更新：2026-04-20 15:26

---

## 🔴 当前最高优先级：总结现有工作，投稿论文

**核心任务**：整理 V14 框架 + DogRot + BayesOpt 的实验结果，撰写论文

**论文核心内容**：
- V14 框架（ElasticNetCV baseline + BayesOpt 优化）
- DogRot 预条件化（备选方案，高噪声场景有效）
- 主指标：NMSE
- 数据：PHITS 8×12 / 合成 15×20

**长线方向（已记录，暂不实现）**：
- 方向三：非线性 Elastic Net → Discussion 章节
- 方向四：频域分解 + 分层正则化 → Discussion 亮点
- 方向五：贝叶斯 UQ → 未来工作
